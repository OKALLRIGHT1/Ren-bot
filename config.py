...
QQ_PRIVATE_CONTINUOUS_MESSAGE_ENABLED = get_env_bool(
    "QQ_PRIVATE_CONTINUOUS_MESSAGE_ENABLED", "1"
)
QQ_PRIVATE_CONTINUOUS_DEBOUNCE_SEC = get_env_float(
    "QQ_PRIVATE_CONTINUOUS_DEBOUNCE_SEC", 3.2, min_value=0.1, max_value=30.0
)
QQ_PRIVATE_CONTINUOUS_SHORT_DEBOUNCE_SEC = get_env_float(
    "QQ_PRIVATE_CONTINUOUS_SHORT_DEBOUNCE_SEC",
    2.2,
    min_value=0.1,
    max_value=30.0,
)
QQ_PRIVATE_CONTINUOUS_MAX_TYPING_WAIT_SEC = get_env_float(
    "QQ_PRIVATE_CONTINUOUS_MAX_TYPING_WAIT_SEC",
    12.0,
    min_value=0.5,
    max_value=60.0,
)
QQ_PRIVATE_CONTINUOUS_MAX_ITEMS = get_env_int(
    "QQ_PRIVATE_CONTINUOUS_MAX_ITEMS", 12, min_value=1, max_value=50
)
QQ_PRIVATE_CONTINUOUS_MAX_TEXT_CHARS = get_env_int(
    "QQ_PRIVATE_CONTINUOUS_MAX_TEXT_CHARS", 2400, min_value=100, max_value=12000
)
QQ_PRIVATE_CONTINUOUS_COMMAND_PREFIXES = get_env_list(
    "QQ_PRIVATE_CONTINUOUS_COMMAND_PREFIXES", "/,!,！,#"
)
QQ_PRIVATE_CONTINUOUS_ENABLE_RECALL = get_env_bool(
    "QQ_PRIVATE_CONTINUOUS_ENABLE_RECALL", "1"
)
QQ_PRIVATE_CONTINUOUS_ENABLE_TYPING = get_env_bool(
    "QQ_PRIVATE_CONTINUOUS_ENABLE_TYPING", "1"
)
QQ_PRIVATE_CONTINUOUS_ENABLE_REPLY_CONTEXT = get_env_bool(
    "QQ_PRIVATE_CONTINUOUS_ENABLE_REPLY_CONTEXT", "1"
)
QQ_PRIVATE_CONTINUOUS_ENABLE_FORWARD_CONTEXT = get_env_bool(
    "QQ_PRIVATE_CONTINUOUS_ENABLE_FORWARD_CONTEXT", "1"
)
QQ_PRIVATE_CONTINUOUS_ENABLE_QQ_CARD_LINKS = get_env_bool(
    "QQ_PRIVATE_CONTINUOUS_ENABLE_QQ_CARD_LINKS", "1"
)
QQ_PRIVATE_LINK_ENRICHMENT_ENABLED = get_env_bool(
    "QQ_PRIVATE_LINK_ENRICHMENT_ENABLED", "0"
)
QQ_PRIVATE_LINK_ENRICHMENT_MAX_LINKS = get_env_int(
    "QQ_PRIVATE_LINK_ENRICHMENT_MAX_LINKS", 3, min_value=1, max_value=10
)
QQ_PRIVATE_LINK_ENRICHMENT_TIMEOUT_SEC = get_env_float(
    "QQ_PRIVATE_LINK_ENRICHMENT_TIMEOUT_SEC", 8.0, min_value=1.0, max_value=30.0
)
...
ACTIVITY_AGENT_AUTOSTART = get_env_bool("ACTIVITY_AGENT_AUTOSTART", "0")
ACTIVITY_AGENT_BINARY_PATH = os.getenv("ACTIVITY_AGENT_BINARY_PATH", "").strip()
ACTIVITY_AGENT_PERSISTENT = get_env_bool("ACTIVITY_AGENT_PERSISTENT", "0")
