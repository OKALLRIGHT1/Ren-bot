...
CALLER_TASK_REGISTRY: dict[str, str] = {
    ...
    "capability_gatekeeper": "gatekeeper",
    "capability_route_gatekeeper": "gatekeeper",
    "memory_writeback_extract": "memory_writeback",
    "memory_writeback_summary": "summary",
...
CALLER_DESCRIPTIONS: dict[str, str] = {
    ...
    "capability_gatekeeper": "已选能力的参数确认与抽取（如天气）。",
    "capability_route_gatekeeper": "模糊能力候选的工具选择裁决。",
    "memory_writeback_extract": "长期记忆人物事实抽取写回。",
    "memory_writeback_summary": "长期记忆聊天窗口摘要写回。",
